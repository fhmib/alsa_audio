...
/**
* @brief change 32bit number to 16bit
*
* @param dstBuf
* @param srcBuf
* @param len = sizeof(desBuf)/2
*/
...
/**
* @brief change 16bit number to 32bit 
*
* @param desBuf
* @param srcBuf
* @param len = sizeof(srcBuf)
*/
...
/**
* @brief  G726_Decode progress 
*
* @param G726Handle
* @param srcBuf  input data's buffer 
* @param EncBuf  encode data's buffer
* @param frame  PCM frame
*
* @return  0:error >0:encode data
*/
...
*
* @param G726Handle
* @param srcBuf  source data
* @param DecBuf  decode data
* @param len     source data size 
* @param frame   PCM frame
*
* @return  0:error >0:decode data 
*/
